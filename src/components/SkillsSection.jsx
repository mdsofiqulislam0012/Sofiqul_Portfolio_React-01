...
const skills = [
    ...
    { name: "MySQL", level: 68, category: "backend" },
    { name: "REST API", level: 74, category: "backend" },
                ...
                <div className='flex flex-wrap justify-center gap-4 mb-12'>
                    {
                        categories.map((category, key) => (
                            <button onClick={() => setActiveCategory(category)}
                             className={cn('btn bg-primary w-25 h-10 cursor-pointer px-5 py-2 rounded-full transition-colors duration-300 capitalize',
