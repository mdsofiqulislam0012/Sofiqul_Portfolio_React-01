        ...
        <div className='container flex items-center
         justify-between'>
            ...
            {/* mobile verson */}
                ...
                <button onClick={() => setIsMenuOpen((prev) => !prev)} className='md:hidden p-2 text-foreground z-50' arial-label = {isMenuOpen ? "close menu" : "open menu"}>{isMenuOpen ? <X size={20}></X> : <Menu size={20}></Menu>} </button>
